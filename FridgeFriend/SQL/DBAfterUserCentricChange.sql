...
-- Started on 2026-02-24 20:58:13
...
CREATE TABLE public.categories (
    ...
    CONSTRAINT categories_scope_check CHECK ((((is_system = true) AND (owner_user_id IS NULL)) OR ((is_system = false) AND (owner_user_id IS NOT NULL))))
);
...
CREATE TABLE public.food_types (
    ...
    is_system boolean DEFAULT false NOT NULL,
    owner_user_id integer,
    CONSTRAINT food_types_scope_check CHECK ((((is_system = true) AND (owner_user_id IS NULL)) OR ((is_system = false) AND (owner_user_id IS NOT NULL))))
);
...
CREATE TABLE public.products (
    ...
    is_system boolean DEFAULT false NOT NULL,
    owner_user_id integer,
    CONSTRAINT products_scope_check CHECK ((((is_system = true) AND (owner_user_id IS NULL)) OR ((is_system = false) AND (owner_user_id IS NOT NULL))))
);
...
--
-- TOC entry 4745 (class 2604 OID 16483)
...
--
-- TOC entry 4747 (class 2604 OID 16495)
...
--
-- TOC entry 4757 (class 2604 OID 16576)
...
--
-- TOC entry 4754 (class 2604 OID 16558)
...
--
-- TOC entry 4749 (class 2604 OID 16507)
...
--
-- TOC entry 4760 (class 2604 OID 16628)
...
--
-- TOC entry 4750 (class 2604 OID 16514)
...
--
-- TOC entry 4966 (class 0 OID 16471)
-- Dependencies: 218
-- Data for Name: categories; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.categories (id, name, is_system, owner_user_id) FROM stdin;
1	Fruit	t	\N
2	Vegetables	t	\N
3	Meat	t	\N
4	Other	t	\N
...
--
-- TOC entry 4968 (class 0 OID 16480)
-- Dependencies: 220
-- Data for Name: food_types; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.food_types (id, category, name, is_system, owner_user_id) FROM stdin;
1	1	Apples	t	\N
2	1	Bananas	t	\N
3	1	Strawberries	t	\N
4	2	Carrots	t	\N
5	3	Steak	t	\N
\.
...
--
-- TOC entry 4975 (class 0 OID 16519)
-- Dependencies: 227
...
--
-- TOC entry 4970 (class 0 OID 16492)
-- Dependencies: 222
-- Data for Name: products; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.products (id, food_type, name, barcode, is_system, owner_user_id) FROM stdin;
1	3	Maisy Strawberrys	\N	t	\N
2	2	Maisy Bananas	\N	t	\N
3	4	McDonald Carrots	\N	t	\N
10	1	Heroes	7622202274725	t	\N
11	1	Cookie crisp	8445291254107	t	\N
12	1	Wholegrain Premium Bread	5011059000076	t	\N
13	1	30% Reduced Fat Houmous	5019624002791	t	\N
14	1	Grissini Breadsticks	4335619101067	t	\N
15	2	Crunchy Peanut Butter	5051898719357	t	\N
16	4	Blackcurrant Squash	5054267003378	t	\N
17	5	My authentic greek yoghurt 10%	5202234620329	t	\N
22	4	Tesco Vegetable Soup	5000436960171	t	\N
26	5	Steakyay	1	t	\N
27	1	Lemon	\N	t	\N
28	5	Pb	\N	t	\N
29	4	Milk	\N	t	\N
30	4	Pricetest	\N	t	\N
31	4	Pricetest2	\N	t	\N
32	4	Pricetwst3	\N	t	\N
33	4	Pricetest5	\N	t	\N
\.


--
-- TOC entry 4981 (class 0 OID 16573)
-- Dependencies: 233
...
--
-- TOC entry 4979 (class 0 OID 16555)
-- Dependencies: 231
...
--
-- TOC entry 4972 (class 0 OID 16504)
-- Dependencies: 224
...
--
-- TOC entry 4984 (class 0 OID 16625)
-- Dependencies: 236
...
--
-- TOC entry 4977 (class 0 OID 16535)
-- Dependencies: 229
...
--
-- TOC entry 4982 (class 0 OID 16593)
-- Dependencies: 234
...
--
-- TOC entry 4786 (class 2606 OID 16523)
...
--
-- TOC entry 4774 (class 2606 OID 16497)
...
--
-- TOC entry 4795 (class 2606 OID 16581)
...
--
-- TOC entry 4790 (class 2606 OID 16564)
...
--
-- TOC entry 4792 (class 2606 OID 16566)
...
--
-- TOC entry 4800 (class 2606 OID 16631)
...
--
-- TOC entry 4802 (class 2606 OID 16633)
...
--
-- TOC entry 4798 (class 2606 OID 16598)
...
--
-- TOC entry 4782 (class 2606 OID 16516)
...
--
-- TOC entry 4784 (class 2606 OID 16518)
...
--
-- TOC entry 4767 (class 1259 OID 16670)
-- Name: categories_system_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX categories_system_unique ON public.categories USING btree (lower((name)::text)) WHERE (is_system = true);


--
-- TOC entry 4768 (class 1259 OID 16671)
-- Name: categories_user_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX categories_user_unique ON public.categories USING btree (owner_user_id, lower((name)::text)) WHERE (is_system = false);


--
-- TOC entry 4771 (class 1259 OID 16672)
-- Name: food_types_system_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX food_types_system_unique ON public.food_types USING btree (category, lower((name)::text)) WHERE (is_system = true);


--
-- TOC entry 4772 (class 1259 OID 16673)
-- Name: food_types_user_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX food_types_user_unique ON public.food_types USING btree (owner_user_id, category, lower((name)::text)) WHERE (is_system = false);


--
-- TOC entry 4793 (class 1259 OID 16592)
...
--
-- TOC entry 4796 (class 1259 OID 16609)
...
--
-- TOC entry 4775 (class 1259 OID 16677)
-- Name: products_system_barcode_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX products_system_barcode_unique ON public.products USING btree (barcode) WHERE ((is_system = true) AND (barcode IS NOT NULL));


--
-- TOC entry 4776 (class 1259 OID 16674)
-- Name: products_system_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX products_system_unique ON public.products USING btree (lower((name)::text)) WHERE (is_system = true);


--
-- TOC entry 4777 (class 1259 OID 16676)
-- Name: products_user_barcode_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX products_user_barcode_unique ON public.products USING btree (owner_user_id, barcode) WHERE ((is_system = false) AND (barcode IS NOT NULL));


--
-- TOC entry 4778 (class 1259 OID 16675)
-- Name: products_user_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX products_user_unique ON public.products USING btree (owner_user_id, lower((name)::text)) WHERE (is_system = false);


--
-- TOC entry 4803 (class 2606 OID 16650)
-- Name: categories categories_owner_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.categories
    ADD CONSTRAINT categories_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- TOC entry 4810 (class 2606 OID 16546)
...
--
-- TOC entry 4805 (class 2606 OID 16656)
-- Name: food_types food_types_owner_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.food_types
    ADD CONSTRAINT food_types_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- TOC entry 4808 (class 2606 OID 16524)
...
--
-- TOC entry 4809 (class 2606 OID 16529)
...
--
-- TOC entry 4807 (class 2606 OID 16662)
-- Name: products products_owner_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.products
    ADD CONSTRAINT products_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- TOC entry 4812 (class 2606 OID 16567)
...
--
-- TOC entry 4817 (class 2606 OID 16639)
...
--
-- TOC entry 4818 (class 2606 OID 16644)
...
--
-- TOC entry 4811 (class 2606 OID 16541)
...
--
-- TOC entry 4816 (class 2606 OID 16599)
...
-- Completed on 2026-02-24 20:58:13
